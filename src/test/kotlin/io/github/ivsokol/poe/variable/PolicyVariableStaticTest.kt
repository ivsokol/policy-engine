    ...
    DescribeSpec({
      ...
      describe("cache") {
        it("should resolve to String and not found in cache") {
          ...
          context.cache.get(
              io.github.ivsokol.poe.cache.PolicyStoreCacheEnum.VARIABLE, "value") shouldBe null
        }
        ...
        it("should resolve to LocalDate and found in cache") {
          ...
          context.cache.get(io.github.ivsokol.poe.cache.PolicyStoreCacheEnum.VARIABLE, "1") shouldBe
