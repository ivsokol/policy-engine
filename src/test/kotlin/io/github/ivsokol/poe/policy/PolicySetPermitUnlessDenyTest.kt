...
class PolicySetPermitUnlessDenyTest :
    DescribeSpec({
      val context = Context(event = InMemoryEventTestHandler())

      val combinationLogic = PolicyCombinationLogicEnum.PERMIT_UNLESS_DENY
      ...
      describe("result handling logic") {
        ...
        it("noPermit, just invalid, lenient logic") {
          val given =
              PolicySet(
                  policyCombinationLogic = combinationLogic,
                  policies =
        ...
        it("noPermit, just invalid, strict logic") {
          val given =
              PolicySet(
                  policyCombinationLogic = combinationLogic,
                  strictUnlessLogic = true,
