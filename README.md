...
In the data model [variation](https://ivsokol.github.io/policy-engine/docs/examples/pet-example.md#pet-owner-can-update-pet-information-two-variations-of-pet-object)
